package com.example.dinar.crudmahasiswaik3b.adapter;
...
import com.example.dinar.crudmahasiswaik3b.R;
...
public class MahasiswaAdapter extends ArrayAdapter<Mahasiswa> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView tvFoto = (ImageView) convertView.findViewById(R.id.iv_foto);
        Picasso.get().load(mahasiswa.getFoto()).into(tvFoto);
